...
Procedure SGP4(tsince : double;
  ...
  var
    a1     : double ;  a3ovk2 : double ;  ao     : double ;
    aodp   : double ;  aycof  : double ;  betao  : double ;
    betao2 : double ;  c1     : double ;  c1sq   : double ;
    c2     : double ;  c3     : double ;  c4     : double ;
    c5     : double ;  coef   : double ;  coef1  : double ;
    cosio  : double ;  d2     : double ;  d3     : double ;
    d4     : double ;  del1   : double ;  delmo  : double ;
    delo   : double ;  eeta   : double ;  eosq   : double ;
    eta    : double ;  etasq  : double ;  isimp  : integer ;
    omgcof : double ;  omgdot : double ;  perige : double ;
    pinvsq : double ;  psisq  : double ;  qoms24 : double ;
    s4     : double ;  sinio  : double ;  sinmo  : double ;
    t2cof  : double ;  t3cof  : double ;  t4cof  : double ;
    t5cof  : double ;  temp   : double ;  temp1  : double ;
    temp2  : double ;  temp3  : double ;  theta2 : double ;
    theta4 : double ;  tsi    : double ;  x1m5th : double ;
    x1mth2 : double ;  x3thm1 : double ;  x7thm1 : double ;
    xhdot1 : double ;  xlcof  : double ;  xmcof  : double ;
    xmdot  : double ;  xnodcf : double ;  xnodot : double ;
    xnodp  : double ;
...
Procedure Deep(ideep : integer);
 ...
 var
    ...
    iresfl : integer ;  isynfl : integer ;
    iret   : integer ;  iretn  : integer ;
    ls     : integer ;
    a1     : double ;    a2     : double ;    a3     : double ;
    a4     : double ;    a5     : double ;    a6     : double ;
    a7     : double ;    a8     : double ;    a9     : double ;
    a10    : double ;    ainv2  : double ;    alfdp  : double ;
    aqnv   : double ;    atime  : double ;    betdp  : double ;
    bfact  : double ;    c      : double ;    cc     : double ;
    cosis  : double ;    cosok  : double ;    cosq   : double ;
    ctem   : double ;    d2201  : double ;    d2211  : double ;
    d3210  : double ;    d3222  : double ;    d4410  : double ;
    d4422  : double ;    d5220  : double ;    d5232  : double ;
    d5421  : double ;    d5433  : double ;    dalf   : double ;
    day    : double ;    dbet   : double ;    del1   : double ;
    del2   : double ;    del3   : double ;    delt   : double ;
    dls    : double ;    e3     : double ;    ee2    : double ;
    eoc    : double ;    eq     : double ;    f2     : double ;
    f220   : double ;    f221   : double ;    f3     : double ;
    f311   : double ;    f321   : double ;    f322   : double ;
    f330   : double ;    f441   : double ;    f442   : double ;
    f522   : double ;    f523   : double ;    f542   : double ;
    f543   : double ;    fasx2  : double ;    fasx4  : double ;
    fasx6  : double ;    ft     : double ;    g200   : double ;
    g201   : double ;    g211   : double ;    g300   : double ;
    g310   : double ;    g322   : double ;    g410   : double ;
    g422   : double ;    g520   : double ;    g521   : double ;
    g532   : double ;    g533   : double ;    gam    : double ;
    omegaq : double ;    pe     : double ;    pgh    : double ;
    ph     : double ;    pinc   : double ;    pl     : double ;
    preep  : double ;    s1     : double ;    s2     : double ;
    s3     : double ;    s4     : double ;    s5     : double ;
    s6     : double ;    s7     : double ;    savtsn : double ;
    se     : double ;    se2    : double ;    se3    : double ;
    sel    : double ;    ses    : double ;    sgh    : double ;
    sgh2   : double ;    sgh3   : double ;    sgh4   : double ;
    sghl   : double ;    sghs   : double ;    sh     : double ;
    sh2    : double ;    sh3    : double ;    sh1    : double ;
    shs    : double ;    si     : double ;    si2    : double ;
    si3    : double ;    sil    : double ;    sini2  : double ;
    sinis  : double ;    sinok  : double ;    sinq   : double ;
    sinzf  : double ;    sis    : double ;    sl     : double ;
    sl2    : double ;    sl3    : double ;    sl4    : double ;
    sll    : double ;    sls    : double ;    sse    : double ;
    ssg    : double ;    ssh    : double ;    ssi    : double ;
    ssl    : double ;    stem   : double ;    step2  : double ;
    stepn  : double ;    stepp  : double ;    temp   : double ;
    temp1  : double ;    thgr   : double ;    x1     : double ;
    x2     : double ;    x2li   : double ;    x2omi  : double ;
    x3     : double ;    x4     : double ;    x5     : double ;
    x6     : double ;    x7     : double ;    x8     : double ;
    xfact  : double ;    xgh2   : double ;    xgh3   : double ;
    xgh4   : double ;    xh2    : double ;    xh3    : double ;
    xi2    : double ;    xi3    : double ;    xl     : double ;
    xl2    : double ;    xl3    : double ;    xl4    : double ;
    xlamo  : double ;    xldot  : double ;    xli    : double ;
    xls    : double ;    xmao   : double ;    xnddt  : double ;
    xndot  : double ;    xni    : double ;    xno2   : double ;
    xnodce : double ;    xnoi   : double ;    xnq    : double ;
    xomi   : double ;    xpidot : double ;    xqncl  : double ;
    z1     : double ;    z11    : double ;    z12    : double ;
    z13    : double ;    z2     : double ;    z21    : double ;
    z22    : double ;    z23    : double ;    z3     : double ;
    z31    : double ;    z32    : double ;    z33    : double ;
    zcosg  : double ;    zcosgl : double ;    zcosh  : double ;
    zcoshl : double ;    zcosi  : double ;    zcosil : double ;
    ze     : double ;    zf     : double ;    zm     : double ;
    zmo    : double ;    zmol   : double ;    zmos   : double ;
    zn     : double ;    zsing  : double ;    zsingl : double ;
    zsinh  : double ;    zsinhl : double ;    zsini  : double ;
    zsinil : double ;    zx     : double ;    zy     : double ;
...
Procedure SDP4(tsince : double;
  ...
  var 
    a1     : double ;  a3ovk2 : double ;  ao     : double ;
    aodp   : double ;  aycof  : double ;  betao  : double ;
    betao2 : double ;  c1     : double ;  c2     : double ;
    c4     : double ;  coef   : double ;  coef1  : double ;
    cosg   : double ;  cosio  : double ;  del1   : double ;
    delo   : double ;  eeta   : double ;  eosq   : double ;
    eta    : double ;  etasq  : double ;  omgdot : double ;
    perige : double ;  pinvsq : double ;  psisq  : double ;
    qoms24 : double ;  s4     : double ;  sing   : double ;
    sinio  : double ;  t2cof  : double ;  temp1  : double ;
    temp2  : double ;  temp3  : double ;  theta2 : double ;
    theta4 : double ;  tsi    : double ;  x1m5th : double ;
    x1mth2 : double ;  x3thm1 : double ;  x7thm1 : double ;
    xhdot1 : double ;  xlcof  : double ;  xmdot  : double ;
    xnodcf : double ;  xnodot : double ;  xnodp  : double ;
  ...
  begin
    ...
    betao2 := 0;  c1     := 0;  c2     := 0;
    c4     := 0;  coef   := 0;  coef1  := 0;
    cosg   := 0;  cosio  := 0;  del1   := 0;
    delo   := 0;  eeta   := 0;  eosq   := 0;
    eta    := 0;  etasq  := 0;  omgdot := 0;
    perige := 0;  pinvsq := 0;  psisq  := 0;
    qoms24 := 0;  s4     := 0;  sing   := 0;
    sinio  := 0;  t2cof  := 0;  temp1  := 0;
    temp2  := 0;  temp3  := 0;  theta2 := 0;
    theta4 := 0;  tsi    := 0;  x1m5th := 0;
    x1mth2 := 0;  x3thm1 := 0;  x7thm1 := 0;
    xhdot1 := 0;  xlcof  := 0;  xmdot  := 0;
    xnodcf := 0;  xnodot := 0;  xnodp  := 0;
